...
public class TextBoxTests {
    ...
    void successfulSubmitFormTest() {
        ...
        $("[id=permanentAddress]").setValue("some user no i don't have");
        $("[id=submit]").click();
        ...
        $("p[id=permanentAddress]").shouldHave(
                text("Permananet Address :"), text("some user no i don't have"));
    }
    ...
    void successfulSubmitFormWithSearchInOutputTest() {
        ...
        $("[id=output]").shouldHave(text(userName), text("someemail@mail.ma"),
                text("some user address 74"), text("some user no i don't have"));
    }
    ...
    void successfulSubmitFormWithBadLocatorsTest() {
        ...
        $(".form-control", 3).setValue("some user no i don't have");
        $(byText("Submit")).click();
