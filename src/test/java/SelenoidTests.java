...
public class SelenoidTests {
    ...
    void checkTotal20WithTalkAboutResponse() {
        ...
        System.out.println(response);   // io.restassured.internal.RestAssuredResponseImpl@1af7afb6
        System.out.println(response.toString());    // io.restassured.internal.RestAssuredResponseImpl@1af7afb6
        System.out.println(
                response.asString());    // {"total":20,"used":0,"queued":0,"pending":0,"browsers":{"chrome":{"90.0":{},"91.0":{}},"firefox":{"88.0":{},"89
